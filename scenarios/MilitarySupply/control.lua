...
script.on_init( function()
	...
	add_message_to_scenario_object( mS, "thoughts-unlock-circuit-network" )
	...
	add_message_to_scenario_object( mS, "thoughts-unlock-laser-turret" )
	add_message_to_scenario_object( mS, "thoughts-unlock-light-armor" )
	...
	add_message_to_scenario_object( mS, "thoughts-unlock-solar-panel" )
